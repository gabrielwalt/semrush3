...
| T-005 | 🔲 Open | High | Migrate the Pricing page (/pricing/seo/) — reuse the homepage's frozen block toolbox, style additively, pass GATE 1 + GATE 2. | tools/importer/*, blocks/*, content/pricing.* | New CSS scoped to pricing only; homepage blocks render unchanged (regression-guard) |
